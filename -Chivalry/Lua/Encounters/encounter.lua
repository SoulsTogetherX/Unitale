...
function EncounterStarting()
	...
	Audio.Volume(1)
	Audio.Pitch(1)
	enemies[1].SetVar('currentdialogue', {"[func:Face2]...","[func:Face1]Oh boy! This is going\nto be fun.","So[w:10], human[w:10], you think\nyou can just walk\naround.","Well[w:10], I would just\n[func:Face5]HATE[w:20] to break it to\nyou[w:10],[func:Face9] but...","[func:Face1]The Royal Guard is\nalways watching.","[func:Face5]That me!","[func:Face2]W[w:3]e[w:3]l[w:3]l[w:3].[w:3].[w:3].[w:25][func:Face1] One of many.","But I like to think of\nmyself being[w:10] a\nlittle more[w:20]\n[func:Face5]independent.","...","[func:Face9]I just hope this isn't\ntoo easy.","[func:Face1]The legends say\nhumans are tough.","[func:Face5]But blades are\nsharp!","Human!","I'll show you my true\npower!","I'll show you the\npower of the sword.","I'll show you justice.","And open the\nbarrier[w:25], for monster-\nkind!"})
	State("ENEMYDIALOGUE")
end
