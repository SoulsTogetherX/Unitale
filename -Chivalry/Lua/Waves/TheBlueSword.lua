...
function Update()
	...
	if (timer + 10)%200 == 0 and timer > 10 and (timer + 10)%700 ~= 0 then
	...
	if (timer + 110)%200 == 0 and (timer + 10)%700 ~= 0 then
		local bullet = CreateProjectile("Knife",400, -Arena.height/2 + 10)
		bullet.SetVar("Type",1)
	...
	if (timer + 10)%700 == 0 then
		local bullet = CreateProjectile("Knife",Player.x + 20, -200)
		bullet.SetVar("Type",1)
