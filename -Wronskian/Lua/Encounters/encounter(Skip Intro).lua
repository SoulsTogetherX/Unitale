...
function EncounterStarting()
	...
	Skip = true
	enemies[1].SetVar('currentdialogue', {"[func:State,ACTIONSELECT]"})
	State("ENEMYDIALOGUE")
end
...
function HandleSpare()
	if enemies[1].GetVar("Attack") == 27 then
		...
		enemies[1].SetVar("currentdialogue", {"[effect:none]Wait...","[func:Face11][effect:none]You want to spare\nme?","[effect:none]I-[w:20] Why?","[func:Face5][effect:none]...","[func:Face8][effect:none]Maybe you aren't as\nbad as I thought...","[func:Face4][effect:none]I-","[func:Face1][effect:none]Ok...","[effect:none]I'll spare you[w:10], too.","[func:Face8][effect:none]It's that or death[w:20],\nright?","[effect:none]Heh...","[func:State,ACTIONSELECT]"})
	end
	...
	if enemies[1].GetVar("Attack") < 26 then
		...
		elseif Spare == 3 then
			enemies[1].SetVar("currentdialogue",{"[effect:none][func:Face9]And I really do need\nthe money.","[effect:none][func:Face1]So you're not\ngetting off that\neasily."})
		elseif Spare == 4 then
			enemies[1].SetVar("currentdialogue",{"[effect:none]Can you stop that?","[effect:none][func:Face12]It's annoying."})
		elseif Spare == 5 then
